...
class NotMNIST_RGB(Dataset):
    def __init__(self):
        fname="c:/Users/hongw/OneDrive/Desktop/CMPUT 206/206 ass6/train_data_rgb.npz"  # 修改文件名
...
def main():
    ...
    if params.load_weights != 1:
        ...
        for epoch in range(start_epoch, params.n_epochs):
            ...
            train_loss, train_acc = train(classifier, train_dataloader, criterion, optimizer, device)
            ...
            if epoch % params.val_gap == 0:
                ...
                status_df['loss']['training'] = train_loss
